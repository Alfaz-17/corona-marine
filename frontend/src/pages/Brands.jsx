            ...
            >
              ...
              <div className="card-body">
                ...
                <div className="flex justify-between items-center mt-4">
                  <span className="badge bg-cyan-600 text-white border-0">
                    {product.category}
                  </span>
...
>
  ...
  <div className="hero-content text-center text-white">
    ...
    >
      <h1 className="mb-5 text-5xl font-bold text-cyan-200 drop-shadow-lg">
        Our Trusted Brands
      </h1>
        ...
        >
          <Link to={`/brand/${brand.name}`} className="block">
            ...
            <div className="card-body text-center">
              <h3 className="card-title justify-center text-slate-800">
                {brand.name}
              </h3>
              <p className="text-cyan-700">{brand.description}</p>
              <div className="flex justify-between items-center mt-4">
