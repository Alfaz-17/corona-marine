      ...
      return (
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-marine-navy mb-4">Brand Not Found</h2>
        ...
        <section className="py-20 bg-base-200">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              />
              <h1 className="text-4xl font-bold text-slate-800 mb-4">{brand.name}</h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">{brand.description}</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            {brandProducts.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-xl text-gray-500">No products available for this brand yet.</p>
              </div>
            )}
          </div>
        </section>
    ...
    <div>
      ...
      <section className="hero min-h-96 relative" style={{
        ...
        <div className="hero-content text-center text-white">
          ...
          >
            <h1 className="mb-5 text-5xl font-bold">Our Trusted Brands</h1>
      ...
      <section className="py-20 bg-base-100">
        <div className="container mx-auto px-4">
              ...
              >
                <Link to={`/brand/${brand.name}`} className="block">
                  ...
                  <div className="card-body text-center">
                    <h3 className="card-title justify-center text-slate-800">{brand.name}</h3>
          ...
          {filteredBrands.length === 0 && (
            <div className="text-center py-12">
              <p className="text-xl text-gray-500">No brands found matching your search.</p>
            </div>
          )}
        </div>
      </section>
