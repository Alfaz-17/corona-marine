  ...
  const fetchBrands = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const demoBrands = [
          { id: 1, name: "Caterpillar", description: "Leading manufacturer of marine engines and power systems", logo: "https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg" },
          { id: 2, name: "Furuno", description: "Advanced marine electronics and navigation systems", logo: "https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg" },
          { id: 3, name: "Mustang Survival", description: "Professional marine safety equipment", logo: "https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg" },
          { id: 4, name: "Michigan Wheel", description: "Premium marine propellers and propulsion systems", logo: "https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg" },
          { id: 5, name: "Garmin", description: "Marine GPS and navigation technology", logo: "https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg" },
          { id: 6, name: "Peerless", description: "Marine anchoring and chain systems", logo: "https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg" }
        ];
