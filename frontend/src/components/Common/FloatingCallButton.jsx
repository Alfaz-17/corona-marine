...
const FloatingWhatsappButton = () => {
  return (
    ...
    >
      <a
        href="https://wa.me/916353783332?text=Hi%20I%20want%20to%20know%20more%20about%20your%20products"
        target="_blank"
        rel="noopener noreferrer"
        className="btn btn-circle bg-green-500 hover:bg-green-600 text-white shadow-lg flex items-center justify-center"
      >
        {/* WhatsApp SVG logo */}
        <svg
